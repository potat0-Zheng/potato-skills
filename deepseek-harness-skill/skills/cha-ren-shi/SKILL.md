...
- 本技能目录（`{SKILL_DIR}`）：`C:\Users\郑懿宸\.dsh\skills\cha-ren-shi`
- 破虚妄 技能工具目录：`C:\Users\郑懿宸\.dsh\skills\po-xu-wang\tools\`
...
**只调度 1-2 个最相关工具**，不做全工具并行。工具均复用 破虚妄 技能的现有实现，路径为 `C:\Users\郑懿宸\.dsh\skills\po-xu-wang\tools\`。
